...
如果一个节点收到一个投给某个顶点的票，它当作是对一个顶点中所有事务的投票，并且投票向上传递应用。 当顶点中的所有事务都被接受时，这个顶点就被接受了。 如果一个顶点包含一个被拒绝的事务，那么它将被拒绝，它的所有后代也将被拒绝。 如果一个顶点被拒绝，任何有效的事务将重新发布到一个不是被拒绝顶点的子顶点的新顶点中。 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgyNzUyNjg4MCwxNDA2MTQzOTgzLDE1MT
...
NTAyLDc4Njg2NTQ1NywtMTQyMTc1MjU1NywyMTA3MjI0OTk0LD
EzNjkzNzM1OTUsLTU0MDYxMzkyMSwtNTk2NDUwNjMwXX0=
-->