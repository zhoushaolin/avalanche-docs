...
还有一个**置信度**的概念，它是一个顶点的话单加上它的后代话单的和。 例如，交易**V**有一个凭证。 它也有三个后代有一个单张，因此它的信心从`3`增加到`4`。 类似地，交易**W**和**X**都有一个凭证，它们都有一个凭证的后代，所以它们都有信心`2`, 事务Y有信心`1`。 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEyODE3MzAyNSw3MTA4OTU4OTUsMTEzNz
