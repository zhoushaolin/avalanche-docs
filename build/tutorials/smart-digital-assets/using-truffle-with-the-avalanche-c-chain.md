...
You've completed [Getting Started](../../getting-started.md) and are familiar with the [Avalanche's architecture](../../../learn/platform-overview/). You've also performed a cross-chain swap via the [Transfer AVAX Between X-Chain, P-Chain, and C-Chain](https://github.com/ava-labs/avalanche-docs/tree/7ea07f2c4976026c1d57c08f9fa5d4c4c36b9d9d/build/tutorials/platform/transfer-avax-between-x-chain-and-p-chain/README.md) tutorial.
...
Follow the steps in the [Transfer AVAX Between X-Chain, P-Chain, and C-Chain](https://github.com/ava-labs/avalanche-docs/tree/7ea07f2c4976026c1d57c08f9fa5d4c4c36b9d9d/build/tutorials/platform/transfer-avax-between-x-chain-and-p-chain/README.md) tutorial to fund the newly created account. You'll need to send at least `135422040` nAVAX to the account to cover the cost of contract deployments.
