...
如果你已经有些AVAX，你可以使用你的Avalanche钱包[Avalanche Wallet](https://wallet.avax.network/)，将其汇入你的MetaMask账户。通过选择钱包面板中“**show breakdown**展示**你的余额，可以看到你的资金在哪。如果你的C链中还没有资金，你需要进行一次交叉链转移，以将你的AVAX从X链转入C链。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTg2NDMxMTE5LDE4MTc0OTM2MDVdfQ==
-->