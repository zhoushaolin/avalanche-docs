...
Avalanche还支持不可替换令牌(NFTs)。根据定义，每个非功能性测试都是唯一的，不能与其他非功能性测试完全互换。例如，可能存在代表现实世界艺术品所有权的非功能性内容;每一件艺术品，就像每一件非功能性作品一样，都是独一无二的。nft代表数字稀缺，可能被证明比传统的可替代代币具有更大的实用性。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4OTczNTIzMzFdfQ==
-->