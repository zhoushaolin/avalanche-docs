...
* `denomination`(面值) 确定了用户界面如何显示该资产的余额。如果面值为0，则100个单位的该资产即显示为100。如果面值为1，则100个单位的该资产即显示未10.0。如果面值为2，则100个单位的该资产即显示为100，以此类推。determines how balances of this asset are displayed by user interfaces. If denomination is 0, 100 units of this asset are displayed as 100. If denomination is 1, 100 units of this asset are displayed as 10.0. If denomination is 2, 100 units of this asset are displays as .100, etc.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzgzODkxMzcxLC0xODY2NTY5MjA2LDE5Nz
