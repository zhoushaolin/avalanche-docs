...
如果您正在一台住宅网络连接的计算机上运行节点，则您拥有一个动态IP；换言之，您的IP会定期变化。安装脚本会针对此情况合理配置节点。但是，如果是家庭连接，您需要设置从互联网到节点所安装计算机, 转发`9651` 端口的入站端口。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMjY3NTcwNjksLTEzNzkyMTg5MDUsMT
Q4NzYzMzc4NywxOTg0NTg0NTgwLDE0NzAzMTMzNjMsNTQ4MzAx
OTFdfQ==
-->