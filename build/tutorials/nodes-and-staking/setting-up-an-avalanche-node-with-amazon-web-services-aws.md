...
您再次登录到EC2实例。现在我们需要设置Avalanche节点。为此，请按照[使用安装程序设置Avalanche节点]（使用-安装程序-设-置-节点.md）教程，自动化安装过程。您会需要我们之前设置的“公共IP”。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NjQ2OTQ0NzcsNzEwMjAzNDU1LC02MD
