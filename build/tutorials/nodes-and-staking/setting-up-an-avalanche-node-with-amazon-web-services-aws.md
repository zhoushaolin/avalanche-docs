...
点击屏幕右下角的 **Next: Add Tags**来给实例添加标签。通过标签，我们可以将元数据与我们的实例联系起来。添加一个键为`Name`和值为“我的Avalanche节点”的标签。借此可以明确该实例在您的EC2实例列表中是什么。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0Mjk5NjE5NDcsLTYwMDkwMTczMiwtNj
k5OTAwOTAzXX0=
-->