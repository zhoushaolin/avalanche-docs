...
另一种省钱的方法是使用**Reserved Instance**。就保留实例而言，您得先支付一整年的EC2使用费，并按较低的每小时费率换取锁定。如果您想要长时间运行一个节点，并且不想冒服务中断的风险，那么这是一个很好的省钱选择。同样，选择该选项前，请事先自行调研。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjAwMDMyMDIxLC02MDA5MDE3MzIsLTY5OT
kwMDkwM119
-->