...
选择“Select size”来更改虚拟机大小，然后选择D-Series v4选项下的D2s\_v4\(这个大小有2个内核，8GB内存，并启用优质固态硬盘\）。您也可以使用F2s\_v2实例，它有2个内核、4 GB内存，并启用优质固态硬盘，但对于目前采用现货实例价格的大型虚拟机来说，现货价格实际上更便宜。您可以点击[此链接](https://azure.microsoft.com/en-us/pricing/details/virtual-machines/linux/)查看不同地区的价格。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMTk4Mjk5NiwxMjM0NTEyOTEwLC04NT
gwNzUwMjFdfQ==
-->