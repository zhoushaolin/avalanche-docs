...
为了确保您连好了您的节点，请确保您的节点能够在锁定端口上收到并发送TCP流量\(默认端口`9651`\)，并且您使用命令行参数启动了节点“--public-ip=[您的节点的公共IP]”。如果未做到这一点，则您的质押收益可能会受到影响。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbODUzMTkxOTcyLDc5Mzk5Njc1NCw2MzY1Mz
U0NTBdfQ==
-->