...
通过Avalanche，可以进行质押委托。该参数是其他人将质押委托给验证程序时，验证程序收取的百分比费用。例如，如果委托费率`delegationFeeRate`为“1.2345”，并且有人向验证程序提出委托时，则委托期结束时，1.2345%的收益会分配给验证程序，其余部分则会分配给委托方。
Avalanche 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjAxMjUyMzA3Nyw5MTgxNjA1MjQsMjA5Mj
