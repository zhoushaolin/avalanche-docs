...
我们使用shell命令“date”来计算Unix次数，接下来，10分钟和30天会分别被用作“开始时间”和“结束时间”的值。\(注意：如果您使用的是M，请用“$(gdate”来替换“$(date”。如果您并未安装“gdate”，请执行“混合安装coreutils”。\)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNjEzMzQyODUzLDE1MzM5MDUzOTEsMTA0OD
