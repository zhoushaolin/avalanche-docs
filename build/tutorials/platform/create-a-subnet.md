...
First, let’s generate the 2 control keys. To do so we call [`platform.createAddress`](../../apis/platform-chain-p-chain-api.md#platform-createaddress) This generates a new private key and stores it for a user.
...
To create a subnet, we call [`platform.createSubnet`](../../apis/platform-chain-p-chain-api.md#platform-createsubnet).
...
We can call [`platform.getSubnets`](../../apis/platform-chain-p-chain-api.md#platform-getsubnets) to get all Subnets that exist:
