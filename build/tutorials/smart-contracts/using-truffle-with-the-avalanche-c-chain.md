...
将智能合约部署到C-Chain时，松露将默认使用C-Chain客户端提供的第一个可用帐户，作为迁移期间使用的“发件人”地址。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2ODcxOTI1MzcsLTE2Mzc2MjIyMzgsNz
czMzA1ODI4LDIwNTYxNTIzMSwtMTYwOTY5ODIwMywtOTU1MDUz
NjM4XX0=
-->