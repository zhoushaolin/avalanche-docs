...
Suppose we want to call the `getTxStatus` method of the [X-Chain API](issuing-api-calls.md). The X-Chain API documentation tells us that the endpoint for this API is `/ext/bc/X`.
