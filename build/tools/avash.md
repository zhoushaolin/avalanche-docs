...
要部署和删除网络，需要`.yaml`的网络配置文件。一个例子是在Avash代码库' network/example.network.yaml '中提供的，应该有以下格式:
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU0NzIxOTcwMSwtOTMxOTU2NjUzLDIwMD
MzNTMwMSwtNTg4MDI0MDMsMTQ2NzQ2NzQ2M119
-->