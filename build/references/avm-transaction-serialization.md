...
这个文件是我们如何在雪崩虚拟机(AVM)中序列化事务的唯一来源。 本文档使用[primitive serialization](serialization-primitives.md)格式进行打包，使用[secp256k1](cryptoic -primitives.md#secp256k1-addresses)格式进行加密用户标识。 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDc0NTg0ODZdfQ==
-->